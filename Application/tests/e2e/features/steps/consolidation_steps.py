...
@given('the collection contains files with patterns like "Cover", "Titel", "Inhaltsverzeichnis", "Einleitung", "über den Autor"')
def step_create_mitp_front_matter(context):
    """Create mitp front matter files"""
    patterns = ["Cover", "Titel", "Inhaltsverzeichnis", "Einleitung", "über den Autor"]
...
@then('front matter files (Cover, Titel, Inhaltsverzeichnis, Einleitung, über den Autor) should be placed first in order')
